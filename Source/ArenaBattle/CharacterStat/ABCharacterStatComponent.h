...
protected:
	...
	// Transient : 원래는 속성들이 디스크에 다 저장되는데 현재 hp는 저장이 필요없을 수도(게임마다 다름) 있기때문에 저장하지 않음
	...
	// 기본 스탯
	UPROPERTY(Transient, VisibleInstanceOnly, Category = Stat, Meta = (AloowPrivateAccess = "true"))
